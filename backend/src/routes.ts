...
import { UpdateGuarnicaoController } from './Controllers/Guarnicao/UpdateGuarnicaoController';
import { UpdatePastaController } from './Controllers/Massas/UpdatePastaController';
import { UpdateFishController } from './Controllers/Peixes/UpdateFishController';
...
router.put('/edit-guarnicao', isAuthAuthenticated, new UpdateGuarnicaoController().handle);
router.put('/edit-massa', isAuthAuthenticated, new UpdatePastaController().handle);
router.put('/edit-peixes', isAuthAuthenticated, new UpdateFishController().handle);
router.put('/edit-pizza', isAuthAuthenticated, new UpdatePizzaController().handle);
router.put('/edit-reserva', isAuthAuthenticated, new UpdateReservaController().handle);
